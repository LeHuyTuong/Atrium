        ...
        <main className="flex flex-1 flex-col justify-center px-5 pb-6 sm:px-8 sm:pb-10">
          ...
          >
            {PHASES.map((p) => (
              <div
                key={p.id}
                className="group relative overflow-hidden rounded-xl border border-foreground/12 bg-foreground/[0.025] p-4 backdrop-blur-sm transition-all hover:border-foreground/25 hover:bg-foreground/[0.05]"
